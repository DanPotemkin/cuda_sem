...
petsc_opts = {
    "ksp_type": "gmres",
    "pc_type": 'jacobi', #"hypre",Don't have hypre for cuda so want to directly compare
    "ksp_rtol": 1e-8,
    "ksp_max_it": 20000,
}

#Print out the time it took to setup MPI assembly
print(f"Time to Setup CPU Assembly: {time.time() - start_time}")
