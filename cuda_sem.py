...
'''
    USER VARIABLES (Don't really like arg parsers imo)
'''
...
print(f"Total Number of Grid Points: {size_x * size_y * size_z}")
...
#Should be same (honestly need to assert this :p)
size_x = coords_x.shape[0]
size_y = coords_y.shape[1]
size_z = coords_z.shape[2]

#Generate the coords (this should match how scipy interpolator expectes it I think)
